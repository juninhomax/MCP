...
from slaves.linux.executor import LinuxExecutor
from slaves.linux.tools.registry import registry, register_linux_tools
...
app = FastAPI(
    ...
    description="MCP Slave Linux - Execution Agent",
    version="0.1.0"
)
